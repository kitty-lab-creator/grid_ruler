      ...
      >
        ...
        <div className="text-xs text-slate-600 leading-relaxed space-y-2">
          ...
          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 space-y-1.5 text-[11px]">
            ...
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <CheckCircle2 className="w-3.5 h-3.5 text-blue-600 shrink-0" />
              <span>3 段式參考標線：單鍵切換「控制列+標線 ➔ 純標線(不擋視線) ➔ 關閉」</span>
            </div>
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <CheckCircle2 className="w-3.5 h-3.5 text-blue-600 shrink-0" />
              <span>XY 精準輸入與鎖定：點擊自動清空、🔗 等比聯動縮放、🔒 位置防誤觸鎖定</span>
            </div>
            <div className="flex items-center gap-1.5 font-semibold text-slate-700">
              <CheckCircle2 className="w-3.5 h-3.5 text-blue-600 shrink-0" />
        ...
        <div className="pt-2 border-t border-slate-100 flex flex-col gap-2">
          <div className="flex items-center justify-between text-xs text-slate-500">
            ...
            <span className="font-mono text-[10px] bg-slate-100 px-1.5 py-0.5 rounded text-slate-600">v2.4.0 離線通用版</span>
          </div>
